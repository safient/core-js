export const Networks = [
  {
      ...
      "threadId": [1,85,114,212,182,175,233,193,97,69,223,100,34,98,123,3,46,206,138,237,24,104,120,246,40,142,117,69,209,116,83,205,41,255],
      "ceramic": {
...

  {
      ...
      "threadId": [1,85,110,27,232,39,5,209,131,109,25,61,190,121,193,44,123,71,20,160,3,138,170,18,185,188,107,15,210,228,155,50,49,168],
      "ceramic": {
        "CERAMIC_URL": "http://0.0.0.0:7007",
        "config": {
          "definitions": {
