export const Networks = [
  {
      ...
      "threadId": [1,85,93,22,208,61,246,45,179,96,14,195,135,106,9,37,164,181,23,163,70,154,18,218,58,111,39,47,12,232,152,221,8,141],
      "ceramic": {
...

  {
      ...
      "threadId":  [1,85,169,170,106,224,208,211,57,22,56,218,110,93,51,32,173,247,42,175,129,43,164,80,9,65,218,190,4,116,20,157,248,30],
      "ceramic": {
        "CERAMIC_URL": "http://0.0.0.0:7007",
        "config": {
          "definitions": {
  ...
  },
  {
      ...
      "threadId": [1,85,5,205,238,68,124,233,157,47,49,85,88,94,227,211,182,54,146,83,109,16,102,76,86,36,97,24,210,145,103,180,120,166],
      "ceramic": {
