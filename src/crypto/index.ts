...
import {_decryptData, _encryptData} from "./lib/encryption"
import {_generateCipherKey} from "./tools/aes"
...
export class crypto {
    ...
    secrets: string []
        ...
        try{
            ...
            const shards: Buffer[] = _generateShards(ShareData, 3, 2);
    ...
    reconstructSafeData = async(
        ...
        try {
            ...
            const reconstructedData = _reconstructShards(shards);
